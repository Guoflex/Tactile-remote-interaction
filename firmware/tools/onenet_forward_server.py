...
Flow:
  <ONENET_DEVICE_A_NAME> -> OneNET rule engine -> this server
  -> OneNET property-set API -> <ONENET_DEVICE_B_NAME>
...
Useful environment variables:
  ...
  TARGET_DEVICE_NAME           default: <ONENET_DEVICE_B_NAME>
  EXPECTED_SOURCE_ID           default: <ONENET_DEVICE_A_NAME>
  ONENET_PRODUCT_ID            default: <ONENET_PRODUCT_ID>
...
TARGET_DEVICE_NAME = os.getenv("TARGET_DEVICE_NAME", "<ONENET_DEVICE_B_NAME>")
EXPECTED_SOURCE_ID = os.getenv("EXPECTED_SOURCE_ID", "<ONENET_DEVICE_A_NAME>")
ONENET_PRODUCT_ID = os.getenv("ONENET_PRODUCT_ID", "<ONENET_PRODUCT_ID>")
